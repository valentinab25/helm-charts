...
<dl>
  <dt>Version 1.5.0</dt>
  <dd>Automated release of eeacms/advisory-board-frontend:1.11.4</dd>

  <dt>Version 1.4.0</dt>
  <dd>Automated release of eeacms/advisory-board-frontend:1.11.3</dd>

  <dt>Version 1.3.0</dt>
  <dd>Automated release of eeacms/advisory-board-frontend:1.11.2</dd>

  <dt>Version 1.2.0</dt>
  <dd>Automated release of eeacms/advisory-board-frontend:1.11.1</dd>
